            ...
            <div className="flex flex-col sm:flex-row justify-between items-center">
                <div className="flex items-left  md:flex-row flex-col gap-4">
                    <div className="relative">
                        ...
                        <input type="text" placeholder="Search for Task..." className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg py-2 pl-10 pr-4 focus:outline-none" />
                    </div>
