        ...
        <div className="bg-white dark:bg-slate-900 p-8 rounded-lg shadow-md">
            ...
            <form className="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" defaultValue="John Carter" className="mt-1 block w-full rounded-md bg-slate-100 dark:bg-slate-800 dark:text-gray-400 text-gray-600 px-2 py-2 border-transparent focus:border-purple-500 focus:ring-purple-500" />
                </div>
                <div>
                    <label className="block text-sm font-medium text-slate-600 dark:text-slate-300">Email Address</label>
                    <input type="email" defaultValue="john.carter@example.com" disabled className="mt-1 block w-full rounded-md bg-slate-200 dark:bg-slate-800 px-2 py-2 dark:text-gray-400 text-gray-600 border-transparent cursor-not-allowed" />
                </div>
